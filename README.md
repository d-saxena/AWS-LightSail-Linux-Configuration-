...
5. Clone the Catalog App to the virtual machine `git clone https://github.com/d-saxena/itemCatalog.git`
...
9. Edit `database_setup.py`, `__init__.py` and `database_insert.py` and change `engine = create_engine('sqlite:///bookStore.db')` to `engine = create_engine('postgresql://catalog:password@localhost/catalog')`
10. Install pip `sudo apt-get install python-pip`
11. Install required pip packages
12.. Install psycopg2 `sudo apt-get -qqy install postgresql python-psycopg2`
13. Create database schema `sudo python database_setup.py`
14. Insert dummy data `sudo python database_insert.py`
